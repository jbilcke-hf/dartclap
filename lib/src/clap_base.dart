...
class ClapFile {
  ...
  final ClapFormat format;

  static ClapFile create({
    required ClapMeta meta,
    required List<ClapSegment> segments,
  }) {
    return ClapFile._({
      'meta': meta,
      'segments': segments,
      'format': ClapFormat.clap0,
    });
  }
  ...
  ClapFile._(Map<String, dynamic> parsed)
      : meta = parsed['meta'] as ClapMeta,
        ...
        format = parsed['format'] as ClapFormat? ?? ClapFormat.clap0;
